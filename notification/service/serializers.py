...
class MailingSerializer(serializers.ModelSerializer):
    class Meta:
        model = Mailing
        fields = ('id', 'launch_data', 'end_data', 'text', 'tag', 'mobile_code')
...
class MailingRetrieveSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Mailing
        fields = ('id', 'launch_data', 'end_data', 'text', 'tag', 'mobile_code', 'messages')
...
class MailingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Mailing
        fields = ('id', 'launch_data', 'end_data', 'text', 'tag', 'total_messeges', 'total_sent')
